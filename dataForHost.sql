...
-- Dumping database structure for teaortools
CREATE DATABASE IF NOT EXISTS `teaortools` /*!40100 DEFAULT CHARACTER SET utf8mb3 */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `teaortools`;

-- Dumping data for table teaortools.admin: ~1 rows (approximately)
INSERT INTO `admin` (`email`, `fname`, `lname`, `password`, `v_code`) VALUES
	('mudithawijesigha@gmail.com', 'Muditha', 'Wijesinghe', '123456', '123456');

-- Dumping data for table teaortools.brand: ~10 rows (approximately)
...
-- Dumping data for table teaortools.brand_has_categorie: ~8 rows (approximately)
INSERT INTO `brand_has_categorie` (`brand_brand_id`, `categorie_categorie_id`, `id`) VALUES
	(1, 1, 1),
	(2, 1, 2),
	(3, 1, 3),
	(4, 3, 4),
...
-- Dumping data for table teaortools.cart: ~5 rows (approximately)
INSERT INTO `cart` (`cart_id`, `qty`, `user_email`, `product_product_id`) VALUES
	(36, 50, 'malshan@gmail.com', 13),
	(43, 1, 'nadun@gmail.com', 11),
	(47, 100, 'lathikasanjeewani@gmail.com', 11),
	(62, 15, 'mudithawijesigha@gmail.com', 12),
	(75, 1, 'amali@gmail.com', 21);

-- Dumping data for table teaortools.categorie: ~7 rows (approximately)
...
-- Dumping data for table teaortools.city: ~1,846 rows (approximately)
INSERT INTO `city` (`city_id`, `district_id`, `city_name`, `postcode`) VALUES
	...
	(1330, 16, 'Madipola', '21156'),
	(1331, 16, 'Maduruoya', '51108'),
	...
	(1779, 23, 'Talakolahinna', '70101'),
	(1780, 23, 'Tanjantenna', '70118'),
	(1781, 23, 'Teppanawa', '70512'),
	(1782, 23, 'Tunkama', '70205'),
...
-- Dumping data for table teaortools.color: ~4 rows (approximately)
...
-- Dumping data for table teaortools.condition: ~2 rows (approximately)
INSERT INTO `condition` (`condition_id`, `condition_name`) VALUES
	(1, 'Brand New'),
	(2, 'Used');

-- Dumping data for table teaortools.district: ~25 rows (approximately)
...
-- Dumping data for table teaortools.feedback: ~4 rows (approximately)
INSERT INTO `feedback` (`feed_id`, `feedback`, `feed_type`, `added_date`, `product_product_id`, `user_email`) VALUES
	(1, 'Good product and fast delivery.', 1, '2024-03-03 10:34:49', 11, 'hinata@gmail.com'),
	(2, 'Good product and fast delivered ', 1, '2024-05-29 18:47:27', 11, 'wishmi@gmail.com'),
	(3, 'Not Good', 3, '2024-05-29 19:12:04', 11, 'muditha@gmail.com'),
	(4, 'good', 1, '2024-05-29 19:13:33', 17, 'muditha@gmail.com'),
	(5, 'Kind a good', 2, '2024-05-30 20:16:40', 17, 'arosha@gmail.com'),
	(6, 'it is really good. I am recommended for other peoples. The best seller i ever met.', 1, '2024-06-04 18:16:38', 18, 'muditha@gmail.com');

-- Dumping data for table teaortools.gender: ~2 rows (approximately)
INSERT INTO `gender` (`gender_id`, `gender_name`) VALUES
	(1, 'Male'),
	(2, 'Female');

-- Dumping data for table teaortools.invoice: ~76 rows (approximately)
INSERT INTO `invoice` (`invoice_id`, `product_id`, `cou_user_email`, `order_id`, `buy_qty`, `total`, `date_time`, `status_id`, `view_id`) VALUES
	(1, 11, 'muditha@gmail.com', '65f69797d6f14', 12, 5000, '2024-01-17 12:41:52', 4, 2),
	(2, 15, 'muditha@gmail.com', '65f69a612d029', 1, 11500, '2024-01-17 12:53:33', 2, 2),
	(6, 13, 'muditha@gmail.com', '65f6a7c8bcf05', 100, 21500, '2024-03-17 13:50:54', 3, 2),
	(7, 15, 'asanka@gmail.com', 'iuuiu78789878', 20, 45000, '2024-04-20 09:49:12', 1, 2),
	(8, 12, 'muditha@gmail.com', '65fa767055627', 1, 6500, '2024-03-20 11:09:15', 1, 2),
	(9, 11, 'muditha@gmail.com', '65fd6f3a40ea5', 20, 4500, '2024-03-22 17:15:50', 4, 2),
	(10, 11, 'wishmi@gmail.com', '65fed72e214d0', 12, 3060, '2024-01-23 18:52:44', 4, 2),
	(11, 11, 'muditha@gmail.com', '65fed80196164', 10, 2700, '2024-03-23 18:55:00', 4, 2),
	(12, 11, 'muditha@gmail.com', '65fed87e45997', 13, 3240, '2024-02-23 18:56:41', 4, 2),
	(13, 16, 'muditha@gmail.com', '65fedb1db733b', 10, 1400, '2024-02-23 19:07:57', 1, 2),
	(14, 16, 'muditha@gmail.com', '65fedb1db733b', 10, 1400, '2024-03-23 19:10:24', 1, 2),
	(15, 16, 'muditha@gmail.com', '65fedcbe295ab', 10, 1400, '2024-03-23 19:14:58', 2, 2),
	(16, 16, 'muditha@gmail.com', '65fedcbe295ab', 10, 1400, '2024-03-23 19:54:41', 3, 2),
	(17, 12, 'hinata@gmail.com', 'test0001', 23, 600, '2024-04-05 19:23:26', 2, 2),
	(18, 11, 'muditha@gmail.com', '661025eb31afd', 100, 20900, '2024-04-05 21:55:34', 4, 2),
	(19, 17, 'muditha@gmail.com', '66102de1c6a03', 100, 6000, '2024-04-05 22:29:40', 4, 2),
	(20, 17, 'arosha@gmail.com', '6610f5f6122ac', 100, 10000, '2024-04-06 12:43:34', 4, 2),
	(21, 16, 'wishmi@gmail.com', '661119bde7cc1', 26, 2040, '2024-04-06 15:16:24', 1, 2),
	(22, 16, 'wishmi@gmail.com', '66111a6f80969', 26, 2040, '2024-04-06 15:19:11', 3, 2),
	(23, 17, 'muditha@gmail.com', '66114ed1417af', 20, 2900, '2024-04-06 19:02:30', 4, 2),
	(24, 17, 'muditha@gmail.com', '66114f884a1d8', 20, 2900, '2024-04-06 19:05:31', 3, 2),
	(25, 11, 'muditha@gmail.com', '6611517c4cee3', 20, 4900, '2024-04-06 19:13:51', 2, 2),
	(26, 17, 'muditha@gmail.com', '6611524755e3b', 20, 2900, '2024-04-06 19:17:12', 2, 2),
	(27, 11, 'nima@gmail.com', '66129d9768d37', 100, 20900, '2024-04-07 18:50:46', 4, 2),
	(28, 12, 'wishmi@gmail.com', '6612b827c43ac', 5, 26500, '2024-04-07 20:44:15', 1, 1),
	(29, 11, 'muditha@gmail.com', '66487fa050f8e', 10, 2900, '2024-05-18 15:45:54', 4, 2),
	(30, 15, 'malshani@gmail.com', 'cgbfgh', 5, 50000, '2024-05-25 12:20:41', 1, 1),
	(31, 15, 'muditha@gmail.com', '6656fc9cbeed9', 2, 21500, '2024-05-29 15:30:22', 1, 1),
	(32, 15, 'muditha@gmail.com', '66570984534c1', 1, 11500, '2024-05-29 16:25:30', 1, 1),
	(33, 16, 'muditha@gmail.com', '665ebf6b31ef5', 1, 1040, '2024-06-04 12:47:46', 1, 1),
	(34, 18, 'muditha@gmail.com', '665f0bab312e0', 500, 30250, '2024-06-04 18:12:48', 4, 2),
	(35, 18, 'muditha@gmail.com', '665fb69359e88', 10, 850, '2024-06-05 06:37:26', 1, 2),
	(36, 12, 'muditha@gmail.com', '665fb69359e88', 2, 11500, '2024-06-05 06:37:26', 1, 1),
	(37, 11, 'muditha@gmail.com', '665fb69359e88', 100, 20900, '2024-06-05 06:37:26', 1, 1),
	(38, 18, 'muditha@gmail.com', '665fc493b71d8', 10, 850, '2024-06-05 07:21:47', 1, 1),
	(39, 12, 'muditha@gmail.com', '665fc493b71d8', 2, 11500, '2024-06-05 07:21:47', 1, 1),
	(40, 23, 'muditha@gmail.com', '665fc493b71d8', 10, 10400, '2024-06-05 07:21:47', 2, 2),
	(41, 18, 'muditha@gmail.com', '665fc493b71d8', 10, 850, '2024-06-05 07:22:16', 1, 1),
	(42, 12, 'muditha@gmail.com', '665fc493b71d8', 2, 11500, '2024-06-05 07:22:16', 1, 1),
	(43, 23, 'muditha@gmail.com', '665fc493b71d8', 10, 10400, '2024-06-05 07:22:16', 2, 2),
	(44, 18, 'arosha@gmail.com', '665fc575747ff', 50, 3150, '2024-06-05 07:25:20', 1, 1),
	(45, 19, 'arosha@gmail.com', '665fc575747ff', 100, 5650, '2024-06-05 07:25:20', 1, 1),
	(46, 18, 'arosha@gmail.com', '665fc575747ff', 50, 3150, '2024-06-05 07:32:10', 1, 1),
	(47, 19, 'arosha@gmail.com', '665fc575747ff', 100, 5650, '2024-06-05 07:32:10', 1, 1),
	(48, 18, 'arosha@gmail.com', '665fc575747ff', 50, 3150, '2024-06-05 07:32:54', 1, 1),
	(49, 19, 'arosha@gmail.com', '665fc575747ff', 100, 5650, '2024-06-05 07:32:54', 1, 1),
	(50, 20, 'arosha@gmail.com', '665fc7bd2ae2f', 100, 4450, '2024-06-05 07:35:07', 1, 1),
	(51, 15, 'arosha@gmail.com', '665fc7bd2ae2f', 2, 21500, '2024-06-05 07:35:07', 1, 1),
	(52, 20, 'arosha@gmail.com', '665fc7bd2ae2f', 100, 4450, '2024-06-05 07:37:29', 1, 1),
	(53, 15, 'arosha@gmail.com', '665fc7bd2ae2f', 2, 21500, '2024-06-05 07:37:29', 1, 1),
	(54, 20, 'arosha@gmail.com', '665fc7bd2ae2f', 100, 4450, '2024-06-05 07:37:42', 1, 1),
	(55, 15, 'arosha@gmail.com', '665fc7bd2ae2f', 2, 21500, '2024-06-05 07:37:42', 1, 1),
	(56, 20, 'arosha@gmail.com', '665fc7bd2ae2f', 100, 4450, '2024-06-05 07:38:02', 1, 1),
	(57, 15, 'arosha@gmail.com', '665fc7bd2ae2f', 2, 21500, '2024-06-05 07:38:02', 1, 1),
	(58, 20, 'arosha@gmail.com', '665fc7bd2ae2f', 100, 4450, '2024-06-05 07:38:19', 1, 1),
	(59, 15, 'arosha@gmail.com', '665fc7bd2ae2f', 2, 21500, '2024-06-05 07:38:19', 1, 1),
	(60, 20, 'arosha@gmail.com', '665fc7bd2ae2f', 100, 4450, '2024-06-05 07:38:32', 1, 1),
	(61, 15, 'arosha@gmail.com', '665fc7bd2ae2f', 2, 21500, '2024-06-05 07:38:32', 1, 1),
	(62, 20, 'arosha@gmail.com', '665fc7bd2ae2f', 100, 4450, '2024-06-05 07:38:43', 4, 2),
	(63, 15, 'arosha@gmail.com', '665fc7bd2ae2f', 2, 21500, '2024-06-05 07:38:43', 1, 1),
	(64, 20, 'arosha@gmail.com', '665fc7bd2ae2f', 100, 4450, '2024-06-05 07:38:59', 1, 1),
	(65, 15, 'arosha@gmail.com', '665fc7bd2ae2f', 2, 21500, '2024-06-05 07:38:59', 1, 1),
	(66, 20, 'arosha@gmail.com', '665fc7bd2ae2f', 100, 4450, '2024-06-05 07:39:22', 1, 2),
	(67, 15, 'arosha@gmail.com', '665fc7bd2ae2f', 2, 21500, '2024-06-05 07:39:22', 1, 1),
	(68, 18, 'muditha@gmail.com', '6660905612b32', 45, 2950, '2024-06-05 21:51:02', 1, 1),
	(69, 23, 'muditha@gmail.com', '6660905612b32', 1, 1400, '2024-06-05 21:51:02', 2, 2),
	(70, 21, 'muditha@gmail.com', '6660905612b32', 60, 3850, '2024-06-05 21:51:02', 1, 2),
	(71, 15, 'muditha@gmail.com', '6660905612b32', 3, 31500, '2024-06-05 21:51:02', 1, 1),
	(72, 18, 'arosha@gmail.com', '66609789929f0', 500, 30150, '2024-06-05 22:21:40', 1, 1),
	(73, 21, 'muditha@gmail.com', '66616e3294bd9', 100, 6250, '2024-06-06 13:37:31', 1, 1),
	(74, 18, 'muditha@gmail.com', '66616e3294bd9', 100, 6250, '2024-06-06 13:37:31', 1, 1),
	(75, 23, 'muditha@gmail.com', '6661a4e458e5a', 1, 1400, '2024-06-06 17:31:05', 1, 1),
	(76, 18, 'muditha@gmail.com', '6661a4e458e5a', 45, 2950, '2024-06-06 17:31:05', 1, 1),
	(77, 21, 'muditha@gmail.com', '6661a4e458e5a', 60, 3850, '2024-06-06 17:31:05', 1, 1),
	(78, 15, 'muditha@gmail.com', '6661a4e458e5a', 3, 31500, '2024-06-06 17:31:05', 1, 1),
	(79, 13, 'wishmi@gmail.com', '6662997902586', 200, 40500, '2024-06-07 10:54:25', 1, 1),
	(80, 13, 'wishmi@gmail.com', '6662997902586', 200, 40500, '2024-06-07 10:54:30', 1, 1);

-- Dumping data for table teaortools.model: ~48 rows (approximately)
...
-- Dumping data for table teaortools.model_has_brand: ~28 rows (approximately)
...
-- Dumping data for table teaortools.model_has_color: ~14 rows (approximately)
INSERT INTO `model_has_color` (`model_model_id`, `color_color_id`, `id`) VALUES
	(10, 2, 1),
	(3, 1, 2),
	(1, 1, 3),
	(6, 1, 5),
...
-- Dumping data for table teaortools.order_status: ~4 rows (approximately)
...
-- Dumping data for table teaortools.product: ~12 rows (approximately)
INSERT INTO `product` (`product_id`, `title`, `price`, `qty`, `discription`, `add_date_time`, `delevery_in_user_city`, `delevery_outof_usre_city`, `brand_has_categorie_id`, `model_has_brand_id`, `condition_condition_id`, `user_email`, `model_has_color_id`, `status_status_id`) VALUES
	(11, 'Tri 2023 tea pant', 200, 770, 'Good and fast grow', '2024-03-01 17:26:01', 600, 900, 1, 3, 1, 'wishmi@gmail.com', 2, 1),
	(12, 'Plucking machine', 5000, 81, 'Good Condition ', '2024-03-01 17:28:48', 1000, 1500, 4, 28, 2, 'nima@gmail.com', 7, 1),
	(13, 'tri 2026 tea plant', 200, 4700, 'good', '2024-03-01 17:38:51', 500, 1500, 1, 6, 1, 'arosha@gmail.com', 5, 1),
	(14, 'tri 2023', 160, 0, 'ertert', '2024-03-01 18:28:49', 100, 500, 1, 3, 1, 'nima@gmail.com', 2, 1),
	(15, 'TU – 709 Tea Fertilizer', 10000, 1481, ' Mixture : TU – 709\r\n Age of Plant : For mature tea after 1st prune', '2024-03-01 19:23:19', 1000, 1500, 8, 30, 1, 'nima@gmail.com', 9, 1),
	(16, 'TRI2021 tea plant', 40, 147, 'best products ', '2024-03-08 21:13:55', 500, 1000, 1, 1, 1, 'lathikasanjeewani@gmail.com', 3, 1),
	(17, 'Ground tea plants', 100, 4740, 'good for ground plantation. fast Grow', '2024-04-05 22:28:22', 500, 1000, 1, 3, 1, 'wishmi@gmail.com', 2, 1),
	(18, 'TRI 2026 tea plant', 60, 1810, 'උසස් ප්‍රමිතියෙන් යුත්\r\nකුඩා තේ වතු සංවර්ධන අධිකාරියේ ලියාපදිංචි \r\nඅගල් 7*5 බදුන් සහිත නිරොගිමත් තේ පැල විකිණීමට ඇත.\r\nපලමු දලු නෙලීම තෙක් සියලුම වගා උපදෙස් නොමිලේ ලබා දෙනු ලැබේ.', '2024-06-04 13:04:12', 150, 250, 1, 6, 1, 'wishmi@gmail.com', 5, 1),
	(19, 'TRI 49 tea plant', 55, 5000, 'TRI 49 බාස්කට් SIZE 5-7 මිල රුපියල් 55  උස අඩ් 1/2 වඩා උස', '2024-06-04 13:13:23', 150, 250, 3, 32, 1, 'wishmi@gmail.com', 11, 1),
	(20, '2025 තේ පැල', 43, 10000, 'Good pants', '2024-06-04 13:19:22', 150, 250, 1, 5, 1, 'wishmi@gmail.com', 12, 1),
	(21, '3014 tea plants', 60, 280, 'good & fast group ', '2024-06-04 13:23:12', 150, 250, 2, 11, 1, 'wishmi@gmail.com', 13, 1),
	(22, '2027 tea plants', 25, 2000, '2023 කාන්ඩයේ  තේ පැල  විකිනීමට ඇත. ඉතා උසස්  තත්වයේ  තේ  පැල. ප්‍රවාහන  පහසිකම් සපයා දිය හැකිය', '2024-06-04 13:37:56', 150, 250, 1, 7, 1, 'wishmi@gmail.com', 14, 1),
	(23, 'Worm castings  natural fertilizer', 1000, 498, ' Worm castings are a natural fertilizer that boost the growth of plants. Mix in your soil, surround your cuttings, or make a plant tea for your plants to drink up organic nutrients. Grab a bag today and see how much your plants love it!', '2024-06-04 15:54:10', 200, 400, 12, 33, 1, 'arosha@gmail.com', 15, 1);

-- Dumping data for table teaortools.product_img: ~23 rows (approximately)
INSERT INTO `product_img` (`path`, `product_product_id`) VALUES
	('img//product//Tri 2023 tea pant_0_65e1c251ac527.png', 11),
	('img//product//Tri 2023 tea pant_1_65e1c251c36fb.png', 11),
	('img//product//Plucking machine_0_65e1c2f879a0c.png', 12),
	('img//product//tri 2026 tea plant_0_65e1c553e3640.png', 13),
	('img//product//tri 2023_0_65e1d1096d0df.png', 14),
	('img//product//tri 2023_1_65e1d1097e959.png', 14),
	('img//product//TU – 709 Tea Fertilizer_0_65e1ddcfa7814.png', 15),
	('img//product//TRI2021 tea plant_0_65eb323bee3fc.png', 16),
	('img//product//Ground tea plants_0_66102daf43fcb.jpeg', 17),
	('img//product//Ground tea plants_1_66102daf5fac4.jpeg', 17),
	('img//product//TRI 2026 tea plant_0_665ec37498469.jpeg', 18),
	('img//product//TRI 2026 tea plant_1_665ec374aa92f.jpeg', 18),
	('img//product//TRI 2026 tea plant_2_665ec374b4c04.jpeg', 18),
	('img//product//TRI 49 tea plant_0_665ec59b8d59a.jpeg', 19),
	('img//product//TRI 49 tea plant_1_665ec59b99d32.jpeg', 19),
	('img//product//TRI 49 tea plant_2_665ec59b9f1ad.jpeg', 19),
	('img//product//2025 තේ පැල_0_665ec7030109f.jpeg', 20),
	('img//product//2025 තේ පැල_1_665ec70307419.jpeg', 20),
	('img//product//2025 තේ පැල_2_665ec7030d3d2.jpeg', 20),
	('img//product//3014 tea plants_0_665ec7e82d2c1.jpeg', 21),
	('img//product//3014 tea plants_1_665ec7e837400.jpeg', 21),
	('img//product//2027 tea plants_0_665ecb5d021af.jpeg', 22),
	('img//product//2027 tea plants_1_665ecb5d0daa8.jpeg', 22),
	('img//product//Worm castings  natural fertilizer_0_665eeb4a4256e.jpeg', 23),
	('img//product//Worm castings  natural fertilizer_1_665eeb4a5d054.jpeg', 23);

-- Dumping data for table teaortools.province: ~9 rows (approximately)
...
-- Dumping data for table teaortools.status: ~2 rows (approximately)
INSERT INTO `status` (`status_id`, `status_name`) VALUES
	(1, 'Active'),
	(2, 'Inactive');

-- Dumping data for table teaortools.user: ~21 rows (approximately)
INSERT INTO `user` (`fname`, `lname`, `email`, `password`, `mobile`, `joined_date`, `v_code`, `status_status_id`, `gender_gender_id`) VALUES
	('Abishek', 'Edirisinghe', 'abishek@gmail.com', '12345', '0712587458', '2024-05-28 16:26:50', NULL, 1, 1),
	('Amali', 'Perera', 'amali@gmail.com', '123456', '0787587589', '2024-05-28 17:53:35', NULL, 1, 2),
	('Arosha', 'Ranathunge', 'arosha@gmail.com', '12345', '0775254585', '2024-02-26 18:26:43', NULL, 1, 2),
	('malshan', 'darmasiri', 'asanka@gmail.com', '12345', '0713713168', '2024-03-08 14:22:24', NULL, 1, 1),
	('Chamode', 'Sathsara', 'chamo@gmail.com', '123456', '0712545254', '2024-05-26 13:05:39', NULL, 1, 1),
	('Dilan', 'Halangoda', 'dilan@gmail.com', '123456', '0781547854', '2024-05-28 17:44:06', NULL, 1, 1),
	('Diluka', 'Kumara', 'diluka@gamil.com', '123456', '0778545856', '2024-05-28 16:49:29', NULL, 1, 1),
	('Hinata', 'Hyuga', 'hinata@gmail.com', '123456', '0725458547', '2024-03-03 09:05:41', NULL, 1, 2),
	('Lasantha', 'Predeep', 'lasa@gmail.com', '123456', '0755458547', '2024-05-28 16:33:23', NULL, 1, 1),
	('Lathika', 'Sanjeewani', 'lathikasanjeewani@gmail.com', '123456', '0744340264', '2024-03-08 20:55:09', NULL, 1, 2),
	('Malshan', 'Darmasiri', 'malshan@gmail.com', '123456', '0783256325', '2024-02-26 19:48:26', NULL, 1, 1),
	('Malshani', 'Apsara', 'malshani@gmail.com', '123456', '0782589631', '2024-05-25 11:50:24', NULL, 1, 2),
	('Muditha', 'Wijesinghe', 'muditha@gmail.com', '123456', '0781234567', '2024-02-22 23:22:39', '66487f8b7e620', 1, 1),
	('Muditha', 'Wijesinghe', 'mudithawijesigha@gmail.com', 'ilovewish', '0787274708', '2024-03-15 09:59:16', '665e8bd56704b', 2, 1),
	('Nadun', 'Perera', 'nadun@gmail.com', '12345', '0725245878', '2024-02-27 14:13:58', NULL, 2, 1),
	('Naduni', 'Lakshani', 'naduni@gmail.com', '123456', '0785258525', '2024-05-28 17:36:33', NULL, 1, 2),
	('Nimal', 'Jayasinghe', 'nima@gmail.com', '12345', '0780252014', '2024-02-29 15:54:46', NULL, 2, 1),
	('Pasindu', 'Owa Gamage', 'pasindu@gmail.com', '123456', '0782525635', '2024-05-28 16:41:25', NULL, 1, 1),
	('Poojani', 'Samarakoon', 'poojani@gmail.com', '123456', '0754545875', '2024-05-28 16:38:20', NULL, 1, 2),
	('Udeshi', 'Hewage', 'udeshi@gmail.com', '123456', '0760202145', '2024-05-28 16:35:39', NULL, 1, 2),
	('Wishmi', 'Chamathka', 'wishmi@gmail.com', '123456', '0781234567', '2024-02-24 22:35:07', '665e8bbc4632e', 1, 2);

-- Dumping data for table teaortools.user_has_address: ~9 rows (approximately)
INSERT INTO `user_has_address` (`user_email`, `city_city_id`, `line1`, `line2`) VALUES
	('arosha@gmail.com', 804, '77/3', 'Ogosta Waththa , Kandy'),
	('asanka@gmail.com', 1016, 'c75/1', 'Alla waththa niyadurupola'),
	('hinata@gmail.com', 1775, '24', 'No lane , Rathnapura'),
	('lathikasanjeewani@gmail.com', 1734, '650 A/1', 'devipahala rd, agalawaththa, kuruwita'),
	('malshan@gmail.com', 1016, '59', 'Niyadurupola , Warakapola'),
	('malshani@gmail.com', 930, 'R6/1 ', 'Weediyawaththa , Miyanawita  , Deraniyagala'),
	('muditha@gmail.com', 930, 'R6/1', 'Weediyawaththa , Miyanawita  , Deraniyagala'),
	('mudithawijesigha@gmail.com', 930, 'R6/1', 'Weediyawaththa , Miyanawita  , Deraniyagala'),
	('nadun@gmail.com', 394, '25', '1st Lane , Boossa'),
	('nima@gmail.com', 52, '23', 'Old Moor Street, 12 , Eppawala'),
	('wishmi@gmail.com', 804, '77/2', 'OgostaWaththa , Kandy');

-- Dumping data for table teaortools.user_img: ~11 rows (approximately)
INSERT INTO `user_img` (`path`, `user_email`) VALUES
	('img//userProfile//Muditha_665e7c8ef40e9.jpeg', 'muditha@gmail.com'),
	('img//userProfile//Wishmi_666193993862e.svg', 'wishmi@gmail.com'),
	('img//userProfile//Chamode_6652e851c51fd.jpeg', 'chamo@gmail.com'),
	('img//userProfile//Arosha_6655b64346778.png', 'arosha@gmail.com'),
	('img//userProfile//Abishek_6655b897b01fe.png', 'abishek@gmail.com'),
	('img//userProfile//Lasantha_6655ba17a52a0.jpeg', 'lasa@gmail.com'),
	('img//userProfile//Udeshi_6655ba93f29bf.png', 'udeshi@gmail.com'),
	('img//userProfile//Poojani_6655bb3622758.png', 'poojani@gmail.com'),
	('img//userProfile//Pasindu_6655bbf0d226a.jpeg', 'pasindu@gmail.com'),
	('img//userProfile//Diluka_6655bddd972f0.png', 'diluka@gamil.com'),
	('img//userProfile//Naduni_6655c984d3671.png', 'naduni@gmail.com'),
	('img//userProfile//Dilan_6655cba48b03e.png', 'dilan@gmail.com'),
	('img//userProfile//Amali_6655cd4938953.png', 'amali@gmail.com');

-- Dumping data for table teaortools.view_status: ~2 rows (approximately)
INSERT INTO `view_status` (`view_status_id`, `view_status_name`) VALUES
	(1, 'unview'),
	(2, 'view');

-- Dumping data for table teaortools.wish_list: ~16 rows (approximately)
INSERT INTO `wish_list` (`wish_id`, `user_email`, `product_id`) VALUES
	(10, 'nima@gmail.com', 11),
	(12, 'arosha@gmail.com', 12),
	(15, 'nima@gmail.com', 14),
	(16, 'malshan@gmail.com', 14),
	(18, 'arosha@gmail.com', 14),
	(20, 'nadun@gmail.com', 14),
	(21, 'hinata@gmail.com', 11),
	(22, 'lathikasanjeewani@gmail.com', 14),
	(24, 'arosha@gmail.com', 15),
	(30, 'mudithawijesigha@gmail.com', 16),
	(32, 'mudithawijesigha@gmail.com', 15),
	(33, 'mudithawijesigha@gmail.com', 13),
	(34, 'mudithawijesigha@gmail.com', 12),
	(41, 'arosha@gmail.com', 13),
	(45, 'muditha@gmail.com', 12),
	(46, 'muditha@gmail.com', 18);
