...
?>
    ...
    <head>
        ...
        <title>Brand | Tea or Tools</title>
    </head>
...
<nav class="navbar bg-body-tertiary navbar-expand-md  sticky-top">
      ...
      <!-- l2 -->
           ...
           <div class="row">
            ...
            <button class=" btn btn-primary mt-1 col-10 offset-1 col-md-2 offset-md-8 mt-md-0" onclick="addBrandMode();">Add Brand</button>
           </div>
        </div>
        <!-- model -->
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title">Add Brand to Table</h5>
